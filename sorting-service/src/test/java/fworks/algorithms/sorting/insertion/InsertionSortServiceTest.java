...
public class InsertionSortServiceTest {
  ...
  @Before
  public void setUp() {
    insertionSortService = new InsertionSortServiceImpl();
  }
  ...
  public void commonTest() {
    ...
    SortingResponse sortResponse = insertionSortService.sort(request);
  ...
  public void common2Test() {
    ...
    String[] sort = (String[]) insertionSortService.sort(array, new Counter());
